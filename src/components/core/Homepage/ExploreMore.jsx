...
const ExploreMore = () => {
  ...
  return (
    ...
    <div className="flex justify-start  items-center flex-col">
      ...
      {/* Tabs Section */}
      <div className="hidden lg:flex gap-5 mb-14 -mt-5 mx-auto w-max bg-richblack-800 text-richblack-200 p-1 rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]"> 
