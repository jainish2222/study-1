...
const TimelineSection = () => {
  return (
    <>  
      ...
      <div className="flex flex-col lg:flex-row gap-20 my-20 justify-center items-center">
        ...
        <div className='relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]'>
            ...
            <div className='absolute sm:flex hidden lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-caribbeangreen-700  lg:flex-row flex-col text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10'>             
