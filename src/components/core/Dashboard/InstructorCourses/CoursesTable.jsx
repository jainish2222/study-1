      ...
      <div className="rounded-xl border border-richblack-800 ">
        ...
        <div>
          <div className="flex gap-x-10 rounded-t-md border-b border-b-richblack-800 px-6 py-2">
            <div className="flex-1 text-left text-sm font-medium uppercase text-richblack-100"> Courses </div>
          ...
          {courses?.length === 0 ? (
            ...
            courses?.map((course) => (
              <div key={course._id}  className="flex gap-x-10 border-b border-richblack-800 px-6 py-8" >
                ...
                <div className="text-sm font-medium text-richblack-100"> 2hr 30min </div>
                <div className="text-sm font-medium text-richblack-100"> ₹{course.price} </div>
