    ...
    return (
        <div>
            ...
            text-white justify-between '>
                {/*Section1  */}
                <div className='relative h-full mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between gap-2'>
            ...
            {/* section 2 */}
            <div className='min-h-screen w-full bg-white text-richblack-700 '>
